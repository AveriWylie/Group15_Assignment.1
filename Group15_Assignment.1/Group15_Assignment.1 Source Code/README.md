...
| QUIT | `QUIT` | Disconnect, Must restart client.py (not server) as done above to enter a new client |
...
- Unexpected disconnects are handled without crashing (e.g. Ctrl + C rather than QUIT cmd)
